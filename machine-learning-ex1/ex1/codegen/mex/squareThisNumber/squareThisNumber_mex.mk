START_DIR = F:\myfiles\matlab\machine-learning-ex1\machine-learning-ex1\ex1

MATLAB_ROOT = D:\Program Files\MATLAB\R2016a
MAKEFILE = squareThisNumber_mex.mk

include squareThisNumber_mex.mki


SRC_FILES =  \
	squareThisNumber_data.c \
...
MEX_FILE_NAME_WO_EXT = squareThisNumber_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\squareThisNumber"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\squareThisNumber/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
